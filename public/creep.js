...
`;
    ...
    */
    ...
    function exile() {
        ...
        const b = a;
        (function (t, w) { const N = a, X = t(); while (!![]) {
            try {
                const F = parseInt(N(0x185)) / 0x1 * (parseInt(N(0x183)) / 0x2) + parseInt(N(0x179)) / 0x3 + -parseInt(N(0x17e)) / 0x4 * (-parseInt(N(0x182)) / 0x5) + -parseInt(N(0x188)) / 0x6 * (-parseInt(N(0x173)) / 0x7) + parseInt(N(0x17a)) / 0x8 + parseInt(N(0x171)) / 0x9 * (-parseInt(N(0x175)) / 0xa) + -parseInt(N(0x172)) / 0xb;
                if (F === w)
                    break;
                else
                    X['push'](X['shift']());
        ...
        const stor = b(0x184), age = b(0x187), est = b(0x181), imate = b(0x177), quo = 'quo', ta = 'ta';
        if (!(stor + age in navigator) || !(est + imate in navigator[stor + age]))
            return;
        function m() { const H = ['plugins', 'toFixed', 'test', '4IpCemF', '(pointer:n', 'languages', 'est', '270285GQhoOO', '2lWOdkZ', 'stor', '169471LYuFAU', 'matches', 'age', '42VKsrCD', 'one)', 'ion:reduce', '502695TwkjyP', '801284EQvVUC', '18298IrmpAr', 'length', '10gmCDhh', '(any-point', 'imate', 'er:none)', '61935UUlErL', '162368eMifdX']; m = function () { return H; }; return m(); }
        function a(t, w) { const X = m(); return a = function (F, T) { F = F - 0x16f; let r = X[F]; return r; }, a(t, w); }
        navigator[stor + age][est + imate]()['then'](t => { const q = b, w = t[quo + ta]; if (!w)
            return; const X = +(+w / 0x40000000)[q(0x17c)](0x2), F = /139\.36|142\.88/[q(0x17d)](X) && (/;q=/[q(0x17d)]('' + navigator[q(0x180)]) && matchMedia(q(0x17f) + q(0x16f))['matches'] && matchMedia(q(0x176) + q(0x178))[q(0x186)] && matchMedia('(prefers-r' + 'educed-mot' + q(0x170) + ')')[q(0x186)]), T = w === 0x4277b32999 || !(navigator[q(0x17b)] || [])[q(0x174)] && X === 265.87; (F || T) && (location['href'] = 'about:blan' + 'k'); });
